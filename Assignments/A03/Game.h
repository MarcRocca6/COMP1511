...
//   the top card on the discard pile, AND the player has not already
//   played a card during their turn UNLESS the previous card was a
//   CONTINUE.
// * If a DRAW_TWO was played, the player did not play a card, and
//   instead drew the appropriate number of cards.
...
// * If the player made the SAY_UNO, SAY_DUO, or SAY_TRIO action, then:
//     - the player is at the start of their turn and/or their only
//       previous moves are SAY_UNO, SAY_DUO, or SAY_TRIO, AND they have
//       not yet played that action (i.e. it is not valid to SAY_UNO
//       twice at the start of a turn), or
//     - the player's previous move in this turn was playing a card, AND
//       they now have exactly 1, 2, or 3 cards in their hand (for
//       SAY_UNO, SAY_DUO, and SAY_TRIO respectively)
